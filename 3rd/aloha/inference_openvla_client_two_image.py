...
class OpenVLA:
    ...
    def predict_action(self, payload: Dict[str, Any]) -> str:
        ...
        response = requests.post(
            ...
            json={"image_primary": image_primary, "image_wrist": image_wrist, "instruction": instruction, "unnorm_key": unnorm_key},
        )
...
def inference_process(args, ros_operator, t, openvla_model):
    ...
    while True and not rospy.is_shutdown():
        ...
        img_right = cv2.resize(img_right, (args.img_size, args.img_size))
        ...
        payload = {
            "image_primary": img_front.tolist(),
            "image_wrist": img_right.tolist(),
